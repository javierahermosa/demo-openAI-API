...
if __name__ == '__main__':
    ...
    prompt = 'A photorealistic image of a ship flying::4 in the night sky.'
    ...
    # prompt_edit_image = 'A beautiful picture of a lake. There are no people. Only a chicken on the shore.'
    # image = "lake.png"
    # mask = "lake_mask.png"
