...
if __name__ == '__main__':
    ...
    article_unknown = "what are you talking about? This situation is ridiculous. I want my christmas ornament " \
                      "to read 'Zeffie' but I don't like how the 'Z' looks on that font."

    # Use this prompt to extract a topic, summary and tags for an article with a JSON format response.
    prompt_json = "You are a text classifier, and your response should have four elements including the " \
