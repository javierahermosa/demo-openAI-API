...
if __name__ == '__main__':
    ...
    # 1. Describing what is happening in a short film
    video = "star_wars_violin.MOV"
    prompt = "What is going on this video?"

    # 2. Writing a story based on a short film
    ...
    # 3. Use voice narration to describe what is happening on the video
